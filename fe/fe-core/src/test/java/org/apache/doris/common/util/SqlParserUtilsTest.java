    ...
    public void testRemoveCommentInSql() {
...

        {
            ...
            Assert.assertEquals("select count(*) from test_kylin_fact where price > 10.0;\n" +
                    "select count(*) from test_kylin_fact where price > 10.0", SqlParserUtils.removeCommentInSql(sqlWithComment));
        }

        {
            ...
            Assert.assertEquals("select count(*) from test_kylin_fact   where price > 10.0 \n" +
                    ";insert into test_kylin_fact(id) values(?);", SqlParserUtils.removeCommentInSql(sqlWithComment));
        }
...

        {
            ...
            Assert.assertEquals("select count(*) from test_kylin_fact", SqlParserUtils.removeCommentInSql(sqlWithoutComment));
        }
        {
